...
[Deaconn](https://deaconn.net/) acts as my portfolio which includes a custom-made blog and a lot of information regarding my skills, experience, and social media links. I've created the website from scratch using Python and using a CSS library named Bootstrap. The website's source code may be found [here](https://github.com/Deaconn-net/back-bone) too!
